...
TEST_CASE("Constants element atomic mass are tested", "[constants]")
{
    const std::array atomic_weight_g_mol{
        1.00794, 4.002602, 6.941, 9.012182, 10.811, 12.0107, 14.0067, 15.9994, 18.998403, 20.1797, 22.98976928, 24.305, 26.9815386, 28.0855, 30.973762, 32.065, 35.453, 39.9480, 39.0983, 40.078, 44.955912, 47.867, 50.9415, 51.9961, 54.938045, 55.845, 58.933195, 58.6934, 63.546, 65.409, 69.723, 72.64, 74.92160, 78.960, 79.904, 83.798, 85.4678, 87.62, 88.90585, 91.224, 92.90638, 95.94, 97.0, 101.07, 102.90550, 106.42, 107.8682, 112.411, 114.818, 118.710, 121.760, 127.60, 126.90447, 131.293, 132.9054519, 137.327, 138.90547, 140.116, 140.90765, 144.242, 145.0, 150.36, 151.964, 157.25, 158.92535, 162.500, 164.93032, 167.259, 168.93421, 173.04, 174.967, 178.49, 180.94788, 183.84, 186.207, 190.23, 192.217, 195.084, 196.966569, 200.59, 204.3833, 207.2, 208.98040, 209.0, 210.0, 222.0, 223.0, 226.0, 227.0, 232.03806, 231.03588, 238.02891, 237.0, 244.0, 243.0, 247.0, 247.0, 251.0, 252.0, 257.0, 258.0, 259.0, 266.0, 267.0, 268.0, 269.0
    };
...
TEST_CASE("Constants element atomic mass density are tested", "[constants]")
{
    const std::array rho_g_cm3{
        0.0899, 0.1787, 0.534, 1.85, 2.34, 2.267, 1.2510, 1.4290, 1.6960, 0.9010, 0.971, 1.7400, 2.7000, 2.3300, 1.8200, 2.0700, 3.1700, 1.7840, 0.86, 1.55, 3.0, 4.54, 6.11, 7.15, 7.44, 7.874, 8.86, 8.912, 8.96, 7.134, 5.907, 5.323, 5.776, 4.809, 3.122, 3.7400, 1.532, 2.64, 4.469, 6.506, 8.57, 10.22, 11.5, 12.37, 12.41, 12.02, 10.501, 8.69, 7.31, 7.287, 6.685, 6.232, 4.93, 5.8900, 1.873, 3.594, 6.145, 6.77, 6.773, 7.007, 7.26, 7.52, 5.243, 7.895, 8.229, 8.55, 8.795, 9.066, 9.321, 6.965, 9.84, 13.31, 16.654, 19.25, 21.02, 22.61, 22.56, 21.46, 19.282, 13.5336, 11.85, 11.342, 9.807, 9.32, 7.0, 9.91, 1.87, 5.5, 10.07, 11.72, 15.37, 18.95, 20.45, 19.84, 13.69, 13.51, 14.79, 15.1, 8.84, 9.7, 10.3, 9.9, 15.6, 23.2, 29.3, 35.0
    };
